...
const controls = {
    ...
    Color_Picker: require('./organised/2-input/color_picker'),
    ...
    Date_Picker_Progressive: require('./organised/2-input/date_picker_progressive'),
    Date_Picker_Dropdown: require('./organised/2-input/date_picker_dropdown'),
    Date_Picker_Inline: require('./organised/2-input/date_picker_inline'),
    Date_Picker_Range: require('./organised/2-input/date_picker_range'),
    ...
    Calendar: require('./organised/2-input/calendar'),
    ...
    Property_Grid: require('./organised/2-editor/property_grid'),
    ...
    Status_Bar: require('./organised/2-layout/status_bar'),
    ...
    Document_Tab_Container: require('./organised/2-layout/document_tab_container'),
    ...
    Dialog: require('./organised/2-ui/dialog'),
    Dockable_Panel_System: require('./organised/2-layout/dockable_panel_system'),
    Selection_Handles: require('./organised/2-editor/selection_handles'),
    Snap_Guide_Overlay: require('./organised/2-editor/snap_guide_overlay'),
    Anchor_Editor: require('./organised/2-input/anchor_editor'),
    Dock_Editor: require('./organised/2-input/dock_editor'),
    Collection_Editor: require('./organised/2-input/collection_editor'),
    Font_Picker: require('./organised/2-input/font_picker'),
