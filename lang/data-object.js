...
class Data_Object extends Evented_Class {
            ...
            if (t_spec == 'object') {
                each(spec, function (v, i) {
                    if (typeof that[i] === 'function') {
                        ...
                        //setTimeout(function() {
                        //that[i](v);
                        // has a problem doing this right now, because it is still in the constructor of Data_Object, before the other prototype functions have been added.
                        //  There should be some way to delay this until after the chain of constructors.
                        //}, 0);
                    } else {
    ...
    'toObject'() {
        ...
        // Could just go through the fields... but will need to bring back usage of fields in a good way.
        //  More detailed definition of fields could have use for persistance / serialization / ORM.


        //console.log('this._ ' + stringify(this._));

        // May not really be a _ any longer.
        //  Not sure. Not using it right now.

        /*

        each(this._, function (v, i) {
            if (v.toObject) {
    ...
    */
    ...
    // Could always use a single constraint that gets loaded up with other constraints, or has other constraints in
    //  the way it is defined / described.
    /*
    ...
    */
    ...
    // Will test field constraints more functionally.
        ...
        if (sig == '[s,o]') {
            ...
            if (!is_defined(new_dt_constraint)) {
                ...
                if (fc_item_arr.length > 0) {
                    ...
                    each(fc_item_arr, function (constraint_item, i) {
    ...
    */
    ...
    'matches_field_constraints'() {
        ...
        if (sig == '[D]') {
            ...
            each(fcs, function (constraint, field_name) {
    ...
    */
    ...
    'each'(callback) {
        ...
        // The underscore object could still be very useful.
        //  Less important now that native getters and setters exist.


        // Could have inline code here for speed?

        // Will go over all the fields.
        //  And other necessary values?

        // Could iterate through all of the properties.
